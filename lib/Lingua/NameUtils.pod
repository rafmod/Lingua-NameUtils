...
maintain a list of them, so this module delegates to
I<Lingua::JA::Name::Splitter> which employs a statistical method to identify
Japanese family names written in Kanji and Kana. I don't know what
proportion of the Japanese-named population it identifies.
...
=item B<S<$kcname = kc($name)>> [Internal]
...
Chinese or Korean family name. For example, I<namesplit()> works better for
